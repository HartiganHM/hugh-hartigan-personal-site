        ...
        <div className="link-wrapper">
          <a href="https://github.com/HartiganHM" target="_blank">
            <svg className="icon" viewBox="0 0 436.5 426.8">
              <g>
                <path d="M408.1,106.2c-19.6-33.6-46.2-60.2-79.8-79.8C294.7,6.8,258.1-3,218.3-3c-39.8,0-76.5,9.8-110.1,29.4
         ...
         c2.4,2.3,6.1,3,11.3,2c44.2-14.7,80.2-41.1,108.1-79.2c27.9-38.2,41.8-81.1,41.8-128.9C437.5,176.5,427.7,139.8,408.1,106.2z" />
          ...
          <a href="mailto:hartigan.hm@gmail.com" target="_blank">
            <svg className="icon" viewBox="0 0 512 495.1">
              <g>
                <path d="M256,1L0,192.2v304h512v-304L256,1z M185.2,137.4c7.5-13.7,17.9-24.1,31-30.9c13.1-6.9,28-10.4,45-10.4
		...
		C258.5,146.1,262.3,147.9,265.3,151.3z" />
          ...
          <a href="https://www.linkedin.com/in/hartiganhm/" target="_blank">
            <svg className="icon" viewBox="0 0 512 512">
              <g>
                <path d="M256,0C114.6,0,0,114.6,0,256s114.6,256,256,256s256-114.6,256-256C512,114.6,397.4,0,256,0z M192,380h-64
